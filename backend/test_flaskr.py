...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.new_question = {"question":"What is my favorite programming language?","answer":"Python","category":3,"difficulty":1}
    ...
    #     res = self.client().post('/questions',json={"question":"What is my favorite programming language?","answer":"Python","category":51,"difficulty":1})
    #     data = json.loads(res.data)
    ...
    #     res = self.client().post('/quizzes',json={"previous_questions":[18],
    #         "quiz_category":{"type":"Art","id":6}})
    #     data = json.loads(res.data)
